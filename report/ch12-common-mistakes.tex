...
This is the Pyramid Principle violated in its most damaging form: the recommendation appears on slide 47 of a 50-slide deck. The audience spent 40 minutes wondering ``where is this going?'' See Chapter 6 for the Architect's full toolkit on top-down structure.

\textbf{The fix.} State your recommendation in the first three minutes. Spend the remaining time proving why it is right. Apply the SCQA framework (Chapter 4): the Answer appears before the evidence.
...
\sourcefig{infographics/ch12-autopsy.jpg}{The presentation autopsy: structural sins kill, density sins weaken, delivery sins disappoint, design sins merely wound. Fix in that order.}
...
\subsection{A Note on What This Report Does Not Cover}

This report is deliberately silent on the subject of delivery --- voice projection, body language, stage presence, managing nerves, handling Q\&A. This is not an oversight. It is a methodological choice.

\begin{insightbox}[Why Delivery Is Not Here]
Delivery is the performance of a presentation. This report is about the \emph{architecture} of a presentation. The distinction matters because architecture determines whether a presentation \emph{can} persuade; delivery determines whether it \emph{does} persuade on a given day. A brilliant speaker with a badly structured argument will entertain but not convince. A nervous speaker with a perfectly structured argument will convince despite the nerves.

The Storymakers Method focuses on the 80\% that most people skip: the strategic thinking, the structural design, and the visual communication that happen \emph{before} the presenter opens their mouth. Delivery skills --- important as they are --- are a performance discipline, not an architectural one. They require practice, coaching, and stage time, not a report.

If your structure is sound, your story resonates, and your visuals are clear, you can deliver it with shaking hands and a dry mouth and still change minds. If your structure is broken, no amount of charisma will save it.

Build the argument first. The delivery will follow.\endnote{For delivery-specific training, the authors recommend: Carmine Gallo, \emph{Talk Like TED}, St.\ Martin's Press, 2014; Chris Anderson, \emph{TED Talks: The Official TED Guide to Public Speaking}, Mariner Books, 2017; and Nancy Duarte, \emph{Illuminate}, Portfolio, 2016.}
\end{insightbox}
