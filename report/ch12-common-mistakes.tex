...
\textbf{What it looks like.} The presenter opens PowerPoint before opening a text editor. Slides are created in the order they come to mind. The structure emerges accidentally from the sequence of slides rather than from a deliberate argument architecture.

\textbf{Why it happens.} PowerPoint is familiar. A blank text document is intimidating. The illusion of progress---``I have 12 slides already''---provides psychological comfort that masks the absence of a coherent argument.\endnote{Kahneman, Daniel, \emph{Thinking, Fast and Slow}, Farrar, Straus and Giroux, 2011. Kahneman's concept of ``substitution''---replacing a hard question (``What is my argument?'') with an easy one (``What does this slide look like?'')---explains why most presenters begin with formatting rather than thinking.}

\textbf{How to fix it.} Do not open your slide tool until Phase 3 of the Storymakers process. Write your SCQA, Big Idea, Pillars, Blocks, and Loops in a text document. Only when the argument passes the title test---reading action titles alone tells a coherent story---should you create the first slide.

% ============================================================================

\subsection{Sin 2: Topic titles instead of action titles}

\textbf{What it looks like.} Every slide is headed with a noun phrase: ``Market Overview.'' ``Q3 Results.'' ``Competitive Landscape.'' ``Next Steps.'' The audience reads the title and has no idea what the slide argues.

\textbf{Why it happens.} Topic titles are safe. They commit to nothing. ``Market Overview'' cannot be wrong. ``The addressable market tripled since 2022, creating a \$4B opportunity we are not capturing'' can be challenged. Most presenters choose safety over clarity.\endnote{Zelazny, Gene, \emph{Say It with Presentations: How to Design and Deliver Successful Business Presentations}, McGraw-Hill, 2006. Zelazny documented this pattern in the 1990s and called it ``title abdication''---the presenter abdicates the responsibility of making a claim, leaving the audience to extract the argument from the body of the slide.}

\textbf{How to fix it.} Replace every topic title with a complete sentence that states the slide's argument. If you cannot write a sentence, you do not know what the slide argues. Cut it or rethink it.
...
\textbf{What it looks like.} Forty-seven slides. Forty-seven charts. Zero narrative. The presenter ``wanted to be thorough.'' The audience received a data warehouse, not an argument.

\textbf{Why it happens.} The presenter conflates evidence with argument. More data feels like a stronger case. In reality, the audience cannot process 47 data points in 30 minutes. They will remember 3--4 at most. The presenter's job is to choose which 3--4.\endnote{Miller, George A., ``The Magical Number Seven, Plus or Minus Two: Some Limits on Our Capacity for Processing Information,'' \emph{Psychological Review}, Vol.\ 63, No.\ 2, 1956. Miller's landmark paper, updated by Cowan's 2001 research, establishes the cognitive ceiling that every presenter must respect.}

\textbf{How to fix it.} Ask yourself: ``If the audience remembers only three things from this presentation, what should they be?'' Build the presentation around those three things. Everything else is appendix material.
...
\textbf{What it looks like.} Block 2 makes an argument about customer retention. Block 4 makes a similar argument about customer loyalty. The audience senses repetition but cannot articulate why. The presentation feels 30\% too long.

\textbf{Why it happens.} The Pillars were not tested for mutual exclusivity. Retention and loyalty \emph{feel} different but overlap substantially. Without a MECE check, the presenter builds two Blocks where one sufficed.

\textbf{How to fix it.} Apply the Architect's MECE test: do any two Blocks or Loops make the same argument in different language? If yes, merge them. A non-MECE structure wastes audience time and dilutes the argument.\endnote{Rasiel, Ethan M. and Friga, Paul N., \emph{The McKinsey Mind: Understanding and Implementing the Problem-Solving Tools and Management Techniques of the World's Top Strategic Consulting Firm}, McGraw-Hill, 2001. The MECE violation is the most common structural failure in business communication, precisely because overlapping categories \emph{feel} distinct to the author who created them.}

% ============================================================================

\subsection{Sin 12: The Canva trap}

\textbf{What it looks like.} The slides are gorgeous. Gradient backgrounds. Perfectly matched icons. Professional stock photography. Custom colour palettes. The audience is impressed---for about 90 seconds. Then they realise there is no argument beneath the design.

\textbf{Why it happens.} Design tools have become spectacularly easy to use. Canva, Beautiful.ai, and similar platforms produce visually polished output with minimal effort. The result: presenters spend their time on surface quality and mistake aesthetic satisfaction for argumentative rigour.\endnote{Tufte, Edward R., \emph{The Cognitive Style of PowerPoint: Pitching Out Corrupts Within}, Graphics Press, 2006. Tufte's critique of PowerPoint anticipated the Canva era: the easier it is to make slides look good, the less likely the presenter is to question whether the slides \emph{are} good.}

\textbf{How to fix it.} Apply the title test. Read only the action titles. If they do not tell a coherent story, the presentation fails---regardless of how beautiful the slides are. Design amplifies argument. It does not substitute for it.
