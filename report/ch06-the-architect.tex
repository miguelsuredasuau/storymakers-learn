...
In 1973, Barbara Minto published a slim book that would quietly reshape how the consulting industry communicates. \emph{The Pyramid Principle} argued that every piece of business writing --- and by extension, every presentation --- should be structured as a pyramid: one governing idea at the top, supported by a key line of 2--5 arguments, each of which is supported by its own evidence.\endnote{Minto, Barbara, \emph{The Pyramid Principle: Logic in Writing and Thinking}, 3rd ed., Pearson, 2009. Originally developed as an internal training document at McKinsey \& Company in the late 1960s, first published commercially in 1973.}
