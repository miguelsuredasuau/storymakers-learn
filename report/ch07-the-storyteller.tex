...
\subsection{Freytag's Pyramid: The Five-Act Structure That Works in Business}

The structure of a persuasive narrative has been perfected over thousands of years. One of the most useful formalisations is Freytag's Pyramid, developed in the 19th century by German novelist Gustav Freytag to analyse classical drama.\endnote{Harrison Monarth, ``The Irresistible Power of Storytelling as a Strategic Business Tool,'' \emph{Harvard Business Review}, 2014. A Johns Hopkins study found that Super Bowl ads following Freytag's five-act structure were consistently the most popular and successful.}

The five acts translate directly to business presentations:

\begin{enumerate}
  \item \textbf{Exposition:} The current state. ``Our market share has been flat for three years.''
  \item \textbf{Rising Action:} The complication intensifies. ``A new competitor is eroding our margins and stealing key clients.''
  \item \textbf{Climax:} The moment of decision. ``We must launch now --- imperfect but first --- or wait six months and risk irrelevance.''
  \item \textbf{Falling Action:} The consequences unfold. ``We launched. The marketing team ran a guerrilla campaign. Sales focused on loyal clients.''
  \item \textbf{D\'enouement:} The resolution. ``Six months later, we've grown market share to 25\% and redefined the conversation.''
\end{enumerate}

\begin{insightbox}[The Budweiser Test]
The 2014 Budweiser ``Puppy Love'' Super Bowl ad --- one of the most viral ads in history --- follows Freytag's structure perfectly. Exposition: a puppy and a Clydesdale horse form a friendship. Rising action: the puppy is adopted and driven away. Climax: the horse jumps the fence and blocks the car. Falling action: the owner understands the bond. D\'enouement: puppy and horse reunited. The ad never mentions beer. It tells a universal story about friendship and loyalty, using dramatic structure to create a deep emotional connection that transfers, by association, to the brand.\endnote{Budweiser, ``Puppy Love,'' Super Bowl XLVIII, 2014. The ad generated over 50 million YouTube views in its first week and consistently ranks among the top Super Bowl ads of all time.}
\end{insightbox}

% ============================================================================

\sourcefig{infographics/ch07-yoda.jpg}{You are Yoda, not Luke. The audience faces the quest; your role is to equip them with insight and a plan --- not to make the presentation about your achievements.}
...
\begin{insightbox}[The Neurochemical Symphony]
A masterfully told story is a neurochemical symphony with three movements:\endnote{Zak, Paul J., \emph{The Moral Molecule: The Source of Love and Prosperity}, Dutton, 2012.}

\textbf{Movement 1 --- Cortisol (The Hook):} When your story introduces tension or conflict (the Complication), the audience's brain releases cortisol. In controlled doses, cortisol is a powerful attention capturer. It puts us on alert, focusing intensely on the narrative to discover how the conflict resolves. This is the hook that prevents the audience's mind from wandering.

\textbf{Movement 2 --- Oxytocin (The Bridge):} As the story develops its characters and their struggles, the brain releases oxytocin --- the ``moral molecule.'' Oxytocin is the neurochemical basis of empathy, trust, and social connection. It transforms a passive audience into committed allies who feel connected to the protagonist of your story.

\textbf{Movement 3 --- Dopamine (The Reward):} When the story reaches its climax and resolves satisfyingly, the brain rewards us with dopamine --- the pleasure and motivation hormone. The audience will not only remember your conclusion but will associate it with a feeling of satisfaction and optimism.
\end{insightbox}
...
\sourcefig{infographics/ch07-tension.jpg}{Tension and release: the engine of attention. Let the problem breathe. Let the stakes accumulate. The audience must want the resolution before you give it to them.}
