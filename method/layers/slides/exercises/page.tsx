...
const SLIDES_EXERCISES = [
  LAYERS_EXERCISES.slidesThreeSecond,
  LAYERS_EXERCISES.slidesActionTitle,
  LAYERS_EXERCISES.slidesOneIdea,
];

export default function SlidesExercisesPage() {
  return (
      ...
      <div className="mx-auto max-w-4xl px-6 py-12">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-slate-600">
            Practice exercises to test your understanding of Slides
          </p>
        </div>

        {/* Exercises */}
        <div className="space-y-8">
          {SLIDES_EXERCISES.map((exercise, index) => (
            <div key={exercise.exerciseId}>
              <div className="mb-2 font-medium text-slate-500 text-sm">
                Exercise {index + 1} of {SLIDES_EXERCISES.length}
              </div>
              <Exercise {...exercise} />
            </div>
          ))}
